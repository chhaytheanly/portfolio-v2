<template>
  <div class="container-custom section-padding">
    ...
    <div v-if="filteredProjects.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
      <ScrollReveal v-for="(project, index) in filteredProjects" :key="project.slug" :delay="index * 100">
          ...
          <div
            ...
            <div class="relative aspect-video overflow-hidden flex-shrink-0">
              ...
              <div v-else
                ...
                <svg class="w-16 h-16 text-[var(--color-text-tertiary)]" fill="none" stroke="currentColor"
                  viewBox="0 0 24 24">
              ...
              <!-- Overlay on Hover -->
              <div
                class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-end justify-between p-4">
            ...
            <div class="p-5 flex flex-col flex-1">
              ...
              <div class="flex items-start justify-between gap-2 mb-3">
                <h3
                  class="text-lg font-bold text-[var(--color-text-primary)] group-hover:text-[var(--color-accent)] transition-colors duration-300 line-clamp-2">
                  {{ project.title }}
                </h3>
                <svg
              ...
              <div class="flex flex-wrap gap-2">
                <span v-for="tech in project.tech.slice(0, 4)" :key="tech"
                ...
                <span v-if="project.tech.length > 4"
