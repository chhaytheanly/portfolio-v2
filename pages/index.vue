    ...
    <section class="min-h-[90vh] flex flex-col items-center justify-center container-custom text-center relative overflow-hidden">
      ...
      <div class="relative z-10">
        ...
        >
          ...
          <span class="text-sm font-medium text-[var(--color-accent)]">{{ $t('hero.available') || 'Available for work' }}</span>
        </div>
        <p
          v-motion="'fade-in'"
        ...
        <p
          ...
          class="body-lg max-w-2xl mx-auto mb-10"
        >
          {{ $t('hero.subtitle') }}
        </p>
        <div
      ...
      <div class="absolute bottom-8 animate-bounce">
        <svg
          class="w-6 h-6 text-[var(--color-text-tertiary)]"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
