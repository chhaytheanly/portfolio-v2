      ...
      <div class="flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <div class="flex items-center gap-4">
          <a href="https://github.com" target="_blank" rel="noopener noreferrer"
            ...
            aria-label="GitHub">
            <svg
              class="w-5 h-5 text-[var(--color-text-tertiary)] group-hover:text-[var(--color-accent)] transition-colors duration-300"
        ...
        <div class="text-sm text-[var(--color-text-tertiary)] text-center sm:text-right">
          <p>&copy; {{ new Date().getFullYear() }} LY Chhaythean. {{ $t('footer.rights') }}</p>
          <p class="mt-1">
            {{ $t('footer.builtWith') }}
          </p>
        </div>
